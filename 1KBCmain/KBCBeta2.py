...
COLORS = ['snow', 'ghost white', 'white smoke', 'gainsboro', 'floral white', 'old lace',
            ...
            'light slate gray', 'gray', 'light grey', 'midnight blue', 'navy', 'corn flower blue', 'dark slate blue',
...
def AnswerCheck(temp1,selection):
    if(resultset[temp1][5]==str(selection)):
        mixer.music.load('rightanswer.mp3')
        mixer.music.play()
        time.sleep(4)
        global qstnno
        qstnno+=1
        ...
        mixer.music.load('wronganswer.wav')
        mixer.music.play()
...
ft=open('temp.txt','r')
tname=ft.read()
ltemp=Label(root,text='Welcome to KBL !',bg='purple',fg='gold',font=('Helvetica', 28))
ltemp.place_configure(x=530,y=5)
namelabel=Label(root,text=tname,bg='purple',fg='White',font=('Helvetica', 19))
